...
(N'Hoa hồng đỏ', N'Bó hoa hồng đỏ tươi thắm, biểu tượng của tình yêu', 150000, 50, 'https://i.pravatar.cc/300', N'Hoa hồng'),
(N'Hoa tulip vàng', N'Hoa tulip vàng rực rỡ, mang ý nghĩa may mắn', 120000, 30, 'https://i.pravatar.cc/300', N'Hoa tulip'),
(N'Hoa ly trắng', N'Hoa ly trắng tinh khôi, tượng trưng cho sự thuần khiết', 200000, 25, 'https://i.pravatar.cc/300', N'Hoa ly'),
(N'Hoa cúc họa mi', N'Hoa cúc họa mi nhỏ xinh, phù hợp làm quà tặng', 80000, 40, 'https://i.pravatar.cc/300', N'Hoa cúc'),
(N'Hoa hướng dương', N'Hoa hướng dương tươi sáng, mang năng lượng tích cực', 100000, 35, 'https://i.pravatar.cc/300', N'Hoa hướng dương'),
(N'Hoa hồng trắng', N'Bó hoa hồng trắng tinh khôi, biểu tượng của sự trong sáng', 160000, 45, 'https://i.pravatar.cc/300', N'Hoa hồng'),
(N'Hoa tulip đỏ', N'Hoa tulip đỏ rực rỡ, mang ý nghĩa đam mê', 125000, 28, 'https://i.pravatar.cc/300', N'Hoa tulip'),
(N'Hoa cẩm chướng hồng', N'Hoa cẩm chướng hồng ngọt ngào, tặng mẹ rất ý nghĩa', 90000, 50, 'https://i.pravatar.cc/300', N'Hoa cẩm chướng'),
(N'Hoa lan tím', N'Hoa lan tím quý phái, tượng trưng cho sự sang trọng', 300000, 15, 'https://i.pravatar.cc/300', N'Hoa lan'),
(N'Hoa baby mix', N'Hoa baby nhiều màu sắc, trang trí tiệc cưới lý tưởng', 70000, 60, 'https://i.pravatar.cc/300', N'Hoa baby'),
(N'Hoa đồng tiền cam', N'Hoa đồng tiền cam tươi sáng, mang lại niềm vui', 110000, 30, 'https://i.pravatar.cc/300', N'Hoa đồng tiền'),
(N'Hoa lavender', N'Hoa lavender thơm dịu nhẹ, giúp thư giãn tinh thần', 95000, 25, 'https://i.pravatar.cc/300', N'Hoa lavender');
